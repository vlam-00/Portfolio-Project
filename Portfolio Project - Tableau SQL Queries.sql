/* user=vlam reportName=Portfolio Project - Tableau SQL Queries reportSummary: Queries used for the Tableau data visualization section of my portfolio project */ 
----------------------------------------------------------------------------------------------------
--	1.	
