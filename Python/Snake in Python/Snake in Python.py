...
def toggle_pause():
    ...
    paused = not paused
    if paused:
        print("Game Pause. Press the Esc (Escape) key to resume.")
        pscreen.write("Game Paused.\nPress the Esc (Escape) key to resume.", align="center", font=("Calibri", 24, "normal"))
    else:
        print("Game Resumed.")
        pscreen.clear()
...
def difficulty_screen(screen):
    ...
    difficulty.goto(0, 30)
    difficulty.write("1. Easy", align="center", font=("calibri", 18, "normal"))

    difficulty.goto(0, 0)
    difficulty.write("2. Intermediate", align="center", font=("calibri", 18, "normal"))

    difficulty.goto(0, -30)
    difficulty.write("3. Hard", align="center", font=("calibri", 18, "normal"))

    difficulty.goto(0, -45)
    difficulty.write("4. Master", align="center", font=("calibri", 18, "normal"))
    ...
    # Global variable to store shosen difficulty
